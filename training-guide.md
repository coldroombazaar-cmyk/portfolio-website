...
**Outcome:** A working 4-page responsive portfolio website ("Atanu Mondal — Senior UX Designer") running locally on every student's laptop.
...
1. Open Cursor → **File → Open Folder** → create a new folder on Desktop called `atanu-portfolio` → open it.
...
1. index.html  – an empty HTML5 boilerplate titled "Atanu Mondal | UX Designer"
...
Requirements:
- Brand name on the left: "Atanu Mondal"
...
Page content:
1. A page header section with h1 "About Atanu" (36px) and a one-line subtitle (18px, #6b7280): "Designer. Researcher. Coffee-driven optimist."
2. A two-column section (CSS grid, two equal columns, 48px gap, stacks to one column below 768px):
   - LEFT column: a square placeholder image 400x400px using https://placehold.co/400x400/4f46e5/ffffff?text=Atanu
...
- Three columns (stacks to one column below 768px):
   1. Brand: "Atanu Mondal" + tagline "Designing calm products for noisy industries."
   2. Quick links (same 4 nav links)
   3. Social: LinkedIn, Dribbble, Twitter, Email (use emojis as icons: 💼 🎨 🐦 ✉️)
- Bottom strip with smaller text: "© 2026 Atanu Mondal — Built with curiosity and Cursor."
